    ...
    return(
        <div className="flex items-center justify-center bg-gray-100">
            <div className="mx-auto w-100">
                <div className="max-w-xs cursor-pointer rounded-lg bg-white p-2 shadow duration-150 hover:scale-[102%] hover:shadow-md">
                    <div className="flex items-center justify-between px-4">
                        <p className="font-bold text-gray-500">Ford Fiesta Sedan 1.6 Se Sedan 16v</p>
                    ...
                    <div>
                        <div className="my-4 flex flex-wrap items-center justify-start px-4 gap-y-2 gap-x-1">
                            ...
                            <div className="text-sm font-semibold text-gray-500 flex items-center gap-1">
                                ...
                                <path d="M3.5 9.08997H20.5" stroke="#90A3BF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <path d="M15.6947 13.7H15.7037" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15.6947 16.7H15.7037" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M11.9955 13.7H12.0045" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M11.9955 16.7H12.0045" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8.29431 13.7H8.30329" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8.29431 16.7H8.30329" stroke="#90A3BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                2018/2019
                            </div>
                            <div className="text-sm font-semibold text-gray-500 flex items-center gap-1">
                                ...
                                <path d="M5.42215 14.3941C5.04433 13.3561 4.91755 12.2434 5.05218 11.1469C5.1868 10.0505 5.57901 9.00146 6.19674 8.08565C6.81447 7.16983 7.64017 6.41321 8.60634 5.87766C9.57251 5.3421 10.6517 5.04281 11.7557 5.00426C12.8597 4.96571 13.9572 5.18899 14.9583 5.65585C15.9595 6.12271 16.836 6.81989 17.5161 7.69038C18.1962 8.56088 18.6606 9.57998 18.8714 10.6644C19.0822 11.7487 19.0333 12.8676 18.7288 13.9295" stroke="#90A3BF" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="5 5"/>
                            ...
                            <div className="text-sm font-semibold text-gray-500 flex items-center gap-1 w-100">
                        ...
                        <div className="my-4 flex items-center justify-between px-4">
                            <p className="text-2xl font-semibold text-gray-500">R$ 58.000</p>
                            <div className="rounded-md bg-blue-600 px-4 py-2 text-1xl font-semibold text-white">Ver mais</div>
                        </div>
                    </div>
                </div>
            </div>
