            ...
            <div className="mx-auto w-100">
                <div className="border-[1px] dark:border-blue-900 border-blue-200 rounded-lg dark:bg-slate-800 bg-slate-100 p-2 shadow duration-150 hover:scale-[102%] hover:shadow-md">
                    <div className="flex items-center justify-between px-4">
                        <p className="font-bold dark:text-neutral-200 text-slate-900">Ford Fiesta Sedan 1.6 Se Sedan 16v</p>
                    ...
                    <div>
                        ...
                        <div className="my-4 flex items-center justify-between px-4">
                            <p className="text-2xl font-semibold dark:text-neutral-200 text-slate-900">R$ 58.000</p>
