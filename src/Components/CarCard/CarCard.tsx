...
export default function CarCard() {
    return(
        <div className="flex items-center justify-center bg-gray-100 p-2 slider-card">
            <div className="mx-auto w-100">
                <div className="max-w-xs rounded-lg bg-white p-2 shadow duration-150 hover:scale-[102%] hover:shadow-md">
                    ...
                    <SliderCard images={['../../../car.png', '../../../car.png']}/>
                    <div>
