...
export default async function Footer() {
    ...
    return (
        <footer className="relative flex flex-col gap-6 p-4 lg:gap-8 lg:p-12 mt-auto container">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[2.4fr_2fr_1.2fr_1.2fr_.6fr] justify-between gap-4 flex-wrap">
                ...
                <div className="flex flex-col font-normal text-sm">
                    ...
                    <LinkFooter href="/sobre-nos">Sobre</LinkFooter>
                ...
                <div className="flex flex-col font-normal text-sm">
                    ...
                    <LinkFooter href="/veiculos?quilometros=0_0">Carros 0Km</LinkFooter>
                ...
                <div className="flex flex-col font-normal text-sm">
                    ...
                    <div className="flex gap-2 text-xl">
                        {infoExtras?.instagram &&
                            <Link href={infoExtras?.instagram} className="group" aria-label="Instagram">
                                <BsInstagram className="group-hover:text-blue-600 text-3xl transition-colors"/>
                            </Link>
                        }
                        {infoExtras?.facebook &&
                            <Link href={infoExtras?.facebook} className="group" aria-label="Facebook">
                                <FaSquareFacebook className="group-hover:text-blue-600 text-3xl transition-colors"/>
                            </Link>
                        }
                        {infoExtras?.youtube &&
                            <Link href={infoExtras?.youtube} className="group" aria-label="YouTube">
                                <FaYoutube className="group-hover:text-blue-600 text-3xl transition-colors"/>
                            </Link>
                        }
                        {infoExtras?.twitter &&
                            <Link href={infoExtras?.twitter} className="group" aria-label="Twitter">
                                <FaXTwitter className="group-hover:text-blue-600 text-3xl transition-colors"/>
                            </Link>
                        }
                    </div>
                </div>
            </div>
            <div className="flex justify-between gap-4 flex-col sm:flex-row text-center">
                <div>
